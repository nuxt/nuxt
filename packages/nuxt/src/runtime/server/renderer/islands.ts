...
import { appRootTag } from 'nuxt/internal/renderer-config'
...
function getComponentSlotTeleport (clientUid: string, teleports: Record<string, string>): Record<string, string> {
