...
declare module '#build/server-routes' {
  export type { ErrorBody, GeneratedServerRoutes, Methods, Path, RequestBody, RequestHeaders, RequestQuery, Requires, Response, ResponseHeaders, RouteTypesEngine, StrictFetchPaths, ValidInput } from './build-stub-server-routes'
}
