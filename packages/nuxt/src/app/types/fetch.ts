 ...
 */
export type TypedFetchRequest = Path | Exclude<FetchRequest, string>
...
export type ServerRouteMethods<Request> = Methods<Request>
 ...
 */
export type AvailableServerRouteMethod<Request> = Lowercase<Methods<Request> & string>
 ...
 */
export type TypedRequestShape<Request, Method extends AnyServerRouteMethod> = {
