...
> (
  ...
  const _key = opts.key || hash([autoKey, opts.method ? unref(opts.method as MaybeRef<string>).toUpperCase() : 'GET', unref(opts.baseURL), typeof _request.value === 'string' ? _request.value : '', unref(opts.params || opts.query)])
