...
/**
 * Shows the development error overlay on a page that is already open, for compile
 * failures and for errors the app raises in the browser. The overlay is rendered by
 * the dev server and pushed over the bundler's HMR channel.
 */
export default defineNuxtPlugin({
  ...
  setup (nuxtApp) {
    ...
    // reported once, however many hooks see it: `vue:error` for anything uncaught,
    // `app:error` for what the app renders an error page for
...
/**
 * The error as it was thrown: a `NuxtError` wrapper carries the stack of the code that
 * wrapped it rather than the code that failed.
 */
