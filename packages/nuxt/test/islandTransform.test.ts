  ...
  describe('slots', () => {
      ...
      expect(normalizeLineEndings(result)).toMatchInlineSnapshot(`
        "<template>
              <div>
                ...
                <NuxtTeleportSsrSlot name="named" :props="[{ some-data: someDat }]"><slot name="named" :some-data="someData" /></NuxtTeleportSsrSlot>
                <NuxtTeleportSsrSlot name="other" :props="[{ some-data: someDat }]"><slot
                  name="other"
                  :some-data="someData"
                /></NuxtTeleportSsrSlot>
              </div>
    ...
    it('expect slot fallback transform to match inline snapshot', async () => {
      ...
      expect(normalizeLineEndings(result)).toMatchInlineSnapshot(`
        "<template>
              <div>
                <NuxtTeleportSsrSlot name="default" :props="[{ some-data: someDat }]"><slot :some-data="someData"  /><template #fallback>
                  <div>fallback</div>
