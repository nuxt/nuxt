...
export async function bundle (nuxt: Nuxt & { _nitro?: Nitro }): Promise<void> {
  ...
  nuxt.hook('prepare:types', async (opts) => {
    ...
    opts.references.push({ path: resolve(nuxt.options.rootDir, nitroConfig.typescript!.generatedTypesDir!, 'nitro-routes.d.ts') })
    opts.references.push({ path: resolve(nuxt.options.rootDir, nitroConfig.typescript!.generatedTypesDir!, 'nitro-config.d.ts') })
