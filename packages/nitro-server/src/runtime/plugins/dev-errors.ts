 ...
 * itself, and opens the channel so it is listening before anything requests a page.
 */
...
/** Mirror what the server logs onto the error channel, behind `features.devLogs`. */
