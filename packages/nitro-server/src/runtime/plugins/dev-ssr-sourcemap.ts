...
/**
 * Position in `trace`'s generated code a source position was mapped from, with a 1-based
 * column as in a stack frame. The innermost mapping at or before the column wins.
 */
