...
export type { SSRError, SSRErrorInput } from 'nuxt/internal/renderer/error'
export { NUXT_ERROR_SIGNATURE, SSR_ERROR_PARAM, decodeSSRError, encodeSSRError, stringifyErrorData } from 'nuxt/internal/renderer/error'
