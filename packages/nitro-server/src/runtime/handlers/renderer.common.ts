...
import { writeEarlyHints } from 'nitro/h3'
...
export function returnResponse (event: H3Event, response: Partial<RenderResponse>): any {
...
export async function renderPage (event: H3Event, ssrError: NuxtPayload['error'] & { url: string } | null): Promise<string | undefined> {
