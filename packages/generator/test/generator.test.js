...
describe('generator: generator', () => {
  ...
  test('should initiate with build and init by default', async () => {
    ...
    expect(nuxt.callHook).toBeCalledTimes(1)
    expect(nuxt.callHook).toBeCalledWith('generate:before', generator, { dir: '/var/nuxt/generate' })
...
grey:bar failed`)
  ...
  test('should write fallback html after generate', async () => {
    ...
    expect(path.join).toBeCalledWith('/var/nuxt/generate', 'fallback.html')
    expect(fsExtra.exists).toBeCalledTimes(1)
    expect(fsExtra.exists).toBeCalledWith('join(/var/nuxt/generate, fallback.html)')
    ...
    expect(fsExtra.writeFile).toBeCalledWith('join(/var/nuxt/generate, fallback.html)', 'rendered html', 'utf8')
  })
  ...
  test('should initialize destination folder', async () => {
    ...
    expect(fsExtra.remove).toBeCalledWith('/var/nuxt/generate')
