...
// eslint-disable-next-line @typescript-eslint/no-deprecated
export { assertNuxtCompatibility, checkNuxtCompatibility, getNitroVersion, getNuxtVersion, hasNuxtCompatibility, isNuxtMajorVersion, normalizeSemanticVersion, isNuxt2, isNuxt3 } from './compatibility.ts'
...
// eslint-disable-next-line @typescript-eslint/no-deprecated -- `addServerPlugin` is re-exported for the deprecation window
export { addServerHandler, addDevServerHandler, addNitroPlugin, addServerPlugin, addPrerenderRoutes, useNitro, tryUseNitro, addServerImports, addServerImportsDir, addServerScanDir } from './nitro.ts'
export type { NitroInstance, NitroInstanceOptions } from '@nuxt/schema'
export type { NitroRouteConfig, NitroRouteConfigV2, NitroRouteConfigV3 } from './nitro-types.ts'
