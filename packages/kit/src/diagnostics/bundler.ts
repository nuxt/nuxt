...
export const bundlerDiagnostics = /* #__PURE__ */ defineDiagnostics({
  ...
  codes: {
    NUXT_B7001: {
      ...
      fix: (p: { install: string }) => `Run \`${p.install}\` to enable bundle analysis.`,
      docs: false,
    },
    NUXT_B7002: {
    ...
    NUXT_B7007: {
      ...
      fix: (p: { install: string }) => `Run \`${p.install}\` to install the PostCSS plugin.`,
      docs: false,
    },
    NUXT_B7008: {
    ...
    NUXT_B7009: {
      ...
      fix: (p: { install: string }) => `Run \`${p.install}\` to install the required Babel decorator dependencies.`,
      docs: false,
    },
    NUXT_B7011: {
      why: (p: { pluginName: string }) => `The PostCSS plugin \`${p.pluginName}\` could not be imported, which is unexpected.`,
      fix: (p: { install: string }) => `Run \`${p.install}\` to install it, or report this issue at https://github.com/nuxt/nuxt/issues.`,
      docs: false,
    },
    NUXT_B7012: {
