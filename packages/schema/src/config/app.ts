...
export default defineUntypedSchema({
   ...
   * - If true, Nuxt will first look for a layer with `spaLoadingTemplate` in its `nuxt.config` file and set it as loading template.
   * - If true and no layer has `spaLoadingTemplate` set, Nuxt will look for `~/app/spa-loading-template.html` file or a default Nuxt image will be used.
   *
