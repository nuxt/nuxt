...
describe('registry independence of the fallback shapes', () => {
  ...
  it('type their members through the fallbacks rather than the resolved registry types', () => {
    ...
    expectTypeOf<NitroInstanceOptionsFallback['handlers']>().toEqualTypeOf<ServerHandlerFallback[]>()
    expectTypeOf<NitroInstanceOptionsFallback['devHandlers']>().toEqualTypeOf<DevServerHandlerFallback[]>()
