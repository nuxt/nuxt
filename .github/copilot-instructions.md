<!-- crag:auto-start -->
# Copilot Instructions — nuxt-framework
...
- **ci (inferred from workflow)**: `pnpm lint:docs:fix`
- **ci (inferred from workflow)**: `pnpm test:engines:fix`
- **ci (inferred from workflow)**: `pnpm test:runtime -u`
- **ci (inferred from workflow)**: `pnpm test:unit -u`
- **ci (inferred from workflow)**: `pnpm lint:fix`
- **ci (inferred from workflow)**: `pnpm test:types`
