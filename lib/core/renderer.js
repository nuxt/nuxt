...
export default class Renderer extends Tapable {
  ...
  errorMiddleware (err, req, res, next) {
    ...
    const sendResponse = (content, type = 'text/html') => {
      ...
      const statusMessage = err.statusMessage || err.errorId || (this.options.debug ? err.message : err.name)
      res.statusMessage = statusMessageReg.test(statusMessage) ? statusMessage : err.name
