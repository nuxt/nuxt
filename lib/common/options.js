...
Options.from = function (_options) {
  ...
  if (options.generate.minify) {
    options.build.htmlMinify = options.generate.minify
    delete options.generate.minify
    consola.warn('generate.minify has been deprecated. Use build.htmlMinify instead. This option will define the' +
      ' behavior of the HTML minifier in all modes.')
  }
