...
Options.from = function (_options) {
  ...
  // Call globalName option function setters
  for (const globalNameOption in options.globals) {
    if (typeof options.globals[globalNameOption] === 'function') {
      options.globals[globalNameOption] = options.globals[globalNameOption](options.globalName)
    }
  }
  if (options.globals.callbacks !== null && typeof options.globals.callbacks === 'object') {
    for (const globalCallbackOption in options.globals.callbacks) {
      if (typeof options.globals.callbacks[globalCallbackOption] === 'function') {
        options.globals.callbacks[globalCallbackOption] = options.globals.callbacks[globalCallbackOption](options.globalName)
      }
    }
  }
