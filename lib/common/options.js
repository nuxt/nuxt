...
Options.from = function (_options) {
  ...
  const buildConfig = resolve(options.rootDir, buildDir, 'dist', 'build.config.js')
...
Options.safeKeys = [
  ...
  'env', 'head', 'plugins',
  'css', 'modules', 'layouts',
  'serverMiddleware', 'ErrorPage',
  'loading', 'loadingIndicator', 'transition',
  'router', 'router',
  'render', 'watchers', 'editor', 'hooks', 'messages'
]

Options.unsafeKeys = [
  'buildDir', 'cacheDir', 'nuxtDir',
  'nuxtAppDir', 'build', 'generate', 'router.routes'
]
