...
export default class Generator {
  ...
  async generateRoute({ route, payload = {}, errors = [] }) {
    ...
    if (this.options.generate.minify) {
      ...
      delete this.options.generate.minify
      consola.warn('generate.minify has been deprecated. Use build.htmlMinify instead')
    } else if (typeof this.options.build.htmlMinify === 'undefined') {
      this.options.build.htmlMinify = {
    ...
    if (this.options.build.htmlMinify) {
      try {
        html = htmlMinifier.minify(html, this.options.build.htmlMinify)
