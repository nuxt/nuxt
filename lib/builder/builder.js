...
export default class Builder {
  ...
  determineGlobals () {
    ...
    this.globals = {}
    for (const global in this.options.globals) {
      if (typeof this.options.globals[global] === 'function') {
        this.globals[global] = this.options.globals[global](this.globalName)
      } else {
        this.globals[global] = this.options.globals[global]
      }
    }
  }
