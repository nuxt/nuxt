    ...
    return [
      {
        test: /\.vue$/,
        loader: 'vue-loader',
        options: Object.assign(this.loaders['vue-loader'], this.options.build.vueLoader)
      },
      {
        test: /\.pug$/,
        oneOf: [
          {
            ...
            use: [{
              ...
              options: this.loaders['pug-plain-loader']
            }]
          },
          {
            use: [
      ...
      },
      {
        ...
        use: perfLoader.pool('assets', {
          loader: 'url-loader',
          options: this.loaders['img-url-loader']
        })
      },
      {
        ...
        use: perfLoader.pool('assets', {
          loader: 'url-loader',
          options: this.loaders['font-url-loader']
        })
      },
      {
        test: /\.(webm|mp4|ogv)$/,
        use: perfLoader.pool('assets', {
          loader: 'file-loader',
          options: this.loaders['file-loader']
        })
      }
    ]
  }
