    ...
    return [
      {
        test: /\.vue$/,
        loader: 'vue-loader',
        options: this.loaders.vueLoader
      },
      {
        test: /\.pug$/,
        oneOf: [
          {
            ...
            use: [{
              ...
              options: this.loaders.pugPlainLoader
            }]
          },
          {
            use: [
      ...
      },
      {
        ...
        oneOf: perfLoader.poolOneOf('css', styleLoader.apply('less', {
          loader: 'less-loader',
          options: this.loaders.lessLoader
        }))
      },
      {
        test: /\.sass$/,
        oneOf: perfLoader.poolOneOf('css', styleLoader.apply('sass', {
          loader: 'sass-loader',
          options: this.loaders.sassLoader
        }))
      },
      {
        test: /\.scss$/,
        oneOf: perfLoader.poolOneOf('css', styleLoader.apply('scss', {
          loader: 'sass-loader',
          options: this.loaders.scssLoader
        }))
      },
      {
        test: /\.styl(us)?$/,
        oneOf: perfLoader.poolOneOf('css', styleLoader.apply('stylus', {
          ...
          options: this.loaders.stylusLoader
        }))
      },
      {
