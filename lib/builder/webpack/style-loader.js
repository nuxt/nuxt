...
module.exports = function styleLoader(ext, loaders = [], isVueLoader = false) {
  ...
  if (this.options.build.styleResources && styleResourcesExts[ext]) {
    let key = styleResourcesExts[ext]
    if (this.options.build.styleResources.patternsNuxt[key]) {
      let options = Object.assign({}, this.options.build.styleResources, {
        patterns: this.options.build.styleResources.patternsNuxt[key]
      })
      delete options.patternsNuxt
      loaders.push({
