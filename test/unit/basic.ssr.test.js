...
describe('basic ssr', () => {
  ...
  // test('/body.js (static headers)', async () => {
  //   let _headers, _status
  //   const { html } = await nuxt.renderRoute('/body.js', {
  //     res: {
  ...
  //   expect(_headers['X-Custom']).toBe('custom header')
  //   expect(html.includes('body.js loaded!')).toBe(true)
  // })
