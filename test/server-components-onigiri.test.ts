...
describe.runIf(shouldRun)('server components/islands', () => {
  ...
  it('/server-page', async () => {
    ...
    // `data-internal` on island links needs the island-link navigation support that only exists on main
  })
  ...
  // TODO: needs client-side navigation and prefetch for links inside islands (main-only, nuxt/nuxt#35806)
  it.skip('/server-page - links inside islands use client-side navigation', async () => {
    const { page } = await renderPage('/server-page')
  ...
  // TODO: needs client-side navigation and prefetch for links inside islands (main-only, nuxt/nuxt#35806)
  it.skip('/server-page - island links are prefetched when visible', async () => {
    const { page } = await renderPage('/server-page')
  ...
  // TODO: needs client-side navigation and prefetch for links inside islands (main-only, nuxt/nuxt#35806)
  it.skip('/server-page - island links with `replace` do not add a history entry', async () => {
    const { page } = await renderPage('/')
    await page.getByText('to server page').click()
  ...
  // TODO: needs client-side navigation and prefetch for links inside islands (main-only, nuxt/nuxt#35806)
  it.skip('/server-page - island response is prefetched by NuxtLink', async () => {
