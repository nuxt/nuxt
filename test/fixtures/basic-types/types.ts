...
describe('runtimeConfig', () => {
  ...
  it('provides hints on overriding these values', () => {
    ...
    expectTypeOf(val.runtimeConfig!.public!.APP).toEqualTypeOf<undefined | RuntimeValue<string, 'You can override this value at runtime with NUXT_APP'>>()
    expectTypeOf(val.runtimeConfig!.public!.APP_NAMES).toEqualTypeOf<undefined | RuntimeValue<Array<string>, 'You can override this value at runtime with NUXT_APP_NAMES'>>()
  })
})
