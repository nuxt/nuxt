...
if (import.meta.server) {
  useRequestEvent()!.node.res.appendHeader('set-cookie', 'set-via-h3=h3-value; Path=/')
}
const fromH3 = useCookie('set-via-h3')

if (import.meta.server) {
  useRequestEvent()!.node.res.appendHeader('set-cookie', 'set-via-h3-then-deleted=h3-value; Path=/')
}
