...
Nuxt is not opiniated about state management, so feel free to choose the right solution for your needs.

However here are some pointers to help you make an informed decision.

## Using a third-party library

One of the strengths of Nuxt is its strong modules ecosystem. There are multiple integrations with the most popular state management libraries, including:
...
- [XState](https://nuxt.com/modules/xstate) - state machine approach with tools for visualising and testing your state logic
