...
One of the features Nuxt can give you is a string modules ecosystem. You will find multiple integration with the most popular state management library such as:
