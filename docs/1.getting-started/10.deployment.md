...
Make sure the `NODE_ENV` environment variable is set to `production`. This is necessary because some libraries use this variable, e.g. [vue](https://github.com/vuejs/core/blob/main/packages/runtime-core/index.js)
::
