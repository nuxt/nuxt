...
If you're using Docker or want a consistent development environment across machines, consider using a dev container. [Learn more about dev containers.](/docs/5.x/guide/best-practices/devcontainers)
::
