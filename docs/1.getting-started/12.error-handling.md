...
- Errors during Nitro server lifecycle ([`server/`](/docs/directory-structure/server) directory)
...
This includes:
- running [Nuxt plugins](/docs/directory-structure/app/plugins)
...
::read-more{to="/docs/directory-structure/app/error"}
