...
- Create a component library using [`components/`](/docs/directory-structure/components) directory
- Create utility and composable library using [`composables/`](/docs/directory-structure/composables) and [`utils/`](/docs/directory-structure/utils) directories
