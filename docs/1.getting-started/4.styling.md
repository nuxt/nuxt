...
You can then add your preprocessors source files to the `css` property of your Nuxt configuration.
...
Here are a few modules that are maintained by members of the Nuxt team to help you get started:

- [Uno CSS](https://nuxt.com/modules/unocss) : Instant on-demand atomic CSS engine
