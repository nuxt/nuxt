...
navigation.icon: i-uil-window-section
---
...
::callout
If you only have a single layout in your application, we recommend using `app.vue` with [`<NuxtPage />`](/docs/api/components/nuxt-page) instead.
::
