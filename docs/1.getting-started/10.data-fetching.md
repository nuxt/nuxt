...
::tip{icon="i-lucide-video" to="https://vueschool.io/lessons/to-await-or-not-await-usefetch-blocking-vs-non-blocking?friend=nuxt" target="\_blank"}
Watch this video from Vue School on blocking vs non-blocking (lazy) requests
::
...
::tip{icon="i-lucide-video" to="https://vueschool.io/lessons/how-to-minimize-the-payload-size-with-nuxt-usefetch?friend=nuxt" target="\_blank"}
Watch this video from Vue School on minimizing payload size
::
...
::tip{icon="i-lucide-video" to="https://vueschool.io/lessons/how-to-cache-data-with-the-key-option-for-useasyncdata-and-usefetch?friend=nuxt" target="\_blank"}
Watch this video from Vue School on caching data with the key option
::
...
::tip{icon="i-lucide-video" to="https://vueschool.io/lessons/making-parallel-requests-in-nuxt?friend=nuxt" target="\_blank"}
Watch this video from Vue School on parallel data fetching
::