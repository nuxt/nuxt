...
::alert{type=warning}
If you are changing between layouts, the page transition you set here will not run. Instead, you should set a [layout transition](/docs/getting-started/transitions#layout-transitions).
::
...
For advanced use cases, you can use JavaScript hooks to create custom and highly dynamic transitions for your Nuxt pages.

This way presents perfect use cases for JavaScript animation libraries such as [GSAP](https://greensock.com/gsap) or [TweenJS](https://createjs.com/tweenjs).
