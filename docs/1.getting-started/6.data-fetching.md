...
We heavily recommend you remove any unneeded data or properties to reduce your page's payload size - see the [Minimize the Payload](#minimize-payload) section.
