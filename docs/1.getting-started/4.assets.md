...
By convention, Nuxt uses the `assets/` directory to store these files, but there is no auto-scan functionality for it, and you can use any other name for it.
