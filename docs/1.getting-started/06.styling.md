...
If you're writing local stylesheets, the natural place to put them is the [`assets/` directory](/docs/directory-structure/assets).
...
The natural place for your stylesheets is the [`assets/` directory](/docs/directory-structure/assets). You can then reference its path and Nuxt will include it to all the pages of your application.
...
:read-more{to="/docs/directory-structure/layouts"}
...
Nuxt modules provide you with a good developer experience out of the box, but remember that if your favorite tool doesn't have a module, it doesn't mean that you can't use it with Nuxt! You can configure it yourself for your own project. Depending on the tool, you might need to use a [Nuxt plugin](/docs/directory-structure/plugins) and/or [make your own module](/docs/guide/modules). Share them with the [community](/modules) if you do!
