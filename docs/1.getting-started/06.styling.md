...
If you're writing local stylesheets, the natural place to put them is the [`assets/`](/docs/guide/directory-structure/assets) directory.

### Importing Within Components

You can import stylesheets in your pages, layouts and components directly.
You can use a JavaScript import, or a CSS [`@import`](https://developer.mozilla.org/en-US/docs/Web/CSS/@import) statement.
...
The natural place for your stylesheets is the [`assets/`](/docs/guide/directory-structure/assets) directory. You can then reference its path and Nuxt will include it to all the pages of your application.
