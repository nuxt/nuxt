...
Note: To use the Bun runtime during development, include the --bun flag when executing the dev command. For example:
```bash
bun --bun run dev
```
For more information, check out the [Bun documentation](https://bun.sh/guides/ecosystem/nuxt).
