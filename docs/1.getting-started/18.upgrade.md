...
- **Vite Environment API**: Uses the new [Vite Environment API](/docs/getting-started/upgrade#migration-to-vite-environment-api) for improved build configuration
...
1. Replace `nitro/h3` and `@nuxt/nitro-server/h3` imports with `nuxt/server`, for the utilities in [the surface](/docs/guide/going-further/server-imports#the-surface).
