...
::tip{icon="i-lucide-video" to="https://vueschool.io/lessons/nuxt-4-directory-structure-the-most-significant-change?friend=nuxt" target="\_blank"}
Watch this video from Vue School on the new directory structure
::
