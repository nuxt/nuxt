...
- **File-based routing:** define routes based on the structure of your [`app/pages/` directory](/docs/directory-structure/app/pages). This can make it easier to organize your application and avoid the need for manual route configuration.
