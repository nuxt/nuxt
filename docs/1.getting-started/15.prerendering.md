...
Payloads contain serialized data from `useAsyncData` and `useFetch`. Client-side navigation loads cached payloads instead of re-fetching, improving performance.
