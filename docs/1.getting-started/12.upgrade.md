...
1. Remember to update all of your third-party libraries to work with the new directory structure. E.g., if you use _Tailwind CSS_, update your `tailwind.config.js` to include `app/`:
