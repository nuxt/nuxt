...
navigation.icon: i-uil-arrow-up
---
...
To use the latest Nuxt 3 nightly build and test features before their release, read the [Edge Release Channel](/docs/guide/going-further/edge-channel) guide.
