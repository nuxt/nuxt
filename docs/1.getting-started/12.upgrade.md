...
If you are using Nuxt 3 already and want to upgrade to the latest release or test new features before the public release, head to the [Upgrading Nuxt 3](#upgrading-nuxt-3) section.
...
If you want to migrate your Nuxt 2 application to Nuxt 3 but would also like to do so gradually, you can use Nuxt Bridge. Nuxt Bridge is a compatibility layer that allows you to use Nuxt 3 features in Nuxt 2 with an opt-in mechanism.
