...
3. Add the folders `test/e2e/**/*` & `test/unit/**/*` to your [typescript configuration](#typescript-support-in-tests)
  ...
  typescript: {
    tsConfig: {
      include: [
        ...
        // the paths "../test/nuxt/**/*" and "../tests/nuxt/**/*" are included by default
        '../test/e2e/**/*',
        '../test/unit/**/*',
      ],
    },
