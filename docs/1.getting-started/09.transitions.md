...
You can enable page transitions to apply an automatic transition for all your [pages](/docs/directory-structure/app/pages).
...
To start adding transition between your pages, add the following CSS to your [`app.vue`](/docs/directory-structure/app/app):
...
You can enable layout transitions to apply an automatic transition for all your [layouts](/docs/directory-structure/app/layouts).
...
To start adding transition between your pages and layouts, add the following CSS to your [`app.vue`](/docs/directory-structure/app/app):
...
To apply dynamic transitions using conditional logic, you can leverage inline [middleware](/docs/directory-structure/app/middleware) to assign a different transition name to `to.meta.pageTransition`.
...
By default, view transitions are enabled for all [pages](/docs/directory-structure/app/pages), but you can set a different global default.
