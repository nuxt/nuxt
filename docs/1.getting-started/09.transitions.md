...
You can also provide a `ViewTransitionOptions` object to specify [View Transitions Types](https://developer.chrome.com/blog/view-transitions-update-io24?hl=it#view-transition-types), enabling the implementation of asymmetric transitions.
...
You can also use a `ViewTransitionPageOptions` object, to override the default View Transition Types, or add additional types when the page transitions to or from another page.
