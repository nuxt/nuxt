...
* Capitalize headings following Chicago title case. In short: capitalize the first word, the last word, and all major words (nouns, verbs, adjectives, adverbs, pronouns); lowercase articles, coordinating conjunctions, and prepositions regardless of length (a, and, or, with, from, to...). When in doubt, [capitalizemytitle.com](https://capitalizemytitle.com/style/Chicago) can help.
