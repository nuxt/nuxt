...
We welcome the thoughtful use of AI tools when contributing to Nuxt. To ensure clarity and authenticity in our collaboration, please follow these principles:
...
These guidelines help us maintain quality, collaboration, and shared understanding in the Nuxt community. If you have ideas for improving how we use AI in contributions, we'd love to hear them! ❤️
