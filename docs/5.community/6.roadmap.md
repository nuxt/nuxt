...
| [a11y](https://github.com/nuxt/a11y)   | Public Alpha | 4.x, 5.x     | [nuxt/a11y](https://github.com/nuxt/a11y).      | Real-time accessibility feedback and automated testing in your browser during development (see [nuxt/nuxt#23255](https://github.com/nuxt/nuxt/issues/23255)).        |
...
Nuxt 3 reached end of life on 31 July 2026 and no longer receives bug fixes or security patches. If you are still on Nuxt 3, follow the [upgrade guide](/docs/getting-started/upgrade) to move to Nuxt 4.
