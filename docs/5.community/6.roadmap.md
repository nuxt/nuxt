...
Nuxt 3 reached end of life on 31 July 2026 and no longer receives bug fixes or security patches. If you are still on Nuxt 3, follow the [upgrade guide](/docs/4.x/getting-started/upgrade) to move to Nuxt 4.
