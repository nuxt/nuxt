...
- `packages/language-features`: Vue Language plugin that brings Nuxt-specific IntelliSense improvements, published as [`@nuxt/language-features`](https://npmjs.com/package/@nuxt/language-features).
