...
#extra
  ...
  ---
    ::card-item{ .border .sm:rounded-bl-none .sm:rounded-r-none .sm:rounded-br-none .sm:rounded-tl-lg }
    ---
    ...
    ::
    ::card-item{ .border .sm:rounded-l-none .sm:rounded-br-none .sm:rounded-tr-lg }
    ---
    backgroundClass: 'border dark:border-gray-700'
    border: false
    ringClass: 'ring-0'
    ...
    ::
    ::card-item{ .border .sm:rounded-tl-none .sm:rounded-r-none .sm:rounded-bl-lg }
    ---
    backgroundClass: 'border dark:border-gray-700'
    ringClass: 'ring-0'
    border: false
    ...
    ::
    ::card-item{ .border .sm:rounded-l-none .sm:rounded-br-lg .sm:rounded-tr-none}
    ---
    backgroundClass: 'border dark:border-gray-700'
    ringClass: 'ring-0'
    border: false
