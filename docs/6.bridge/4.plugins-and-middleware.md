...
Plugins now take only one argument (`nuxtApp`). You can find out more in [the docs](/docs/directory-structure/app/plugins).
...
Middleware now take only two argument (`to`, `from`). You can find out more in [the docs](/docs/directory-structure/app/middleware).
