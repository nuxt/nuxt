...
For modern Nuxt projects, we recommend using [TypeScript project references](/docs/directory-structure/tsconfig) instead of directly extending `.nuxt/tsconfig.json`.
::
