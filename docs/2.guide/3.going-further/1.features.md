...
::read-more{to="/docs/4.x/getting-started/upgrade#testing-for-nuxt-5"}
Learn how to test your application with Nuxt 5 compatibility mode in the upgrade guide.
::
