...
App hooks can be used mainly by [Nuxt Plugins](/docs/guide/directory-structure/plugins) to hook into the rendering lifecycle, though it is not blocked off and can be used inside Vue composables as well.
