...
App hooks can be used mainly by [Nuxt Plugins](/docs/guide/directory-structure/plugins) to hook into the rendering lifecycle, though in Vue composables too.
