...
Internally, Nuxt use `@nuxt/schema` to define these experimental features. You can refer to the [source code](https://github.com/nuxt/nuxt/blob/main/packages/schema/src/config/experimental.ts) for more information.
