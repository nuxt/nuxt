...
You can also compute dependencies asynchronously. This is useful when you need to inspect the Nuxt instance or perform I/O before determining the modules configurations:
...
export default defineNuxtModule({
  ...
  async moduleDependencies (nuxt) {
    ...
    return {
      '@nuxt/image': needsImageSupport ? {} : { optional: true },
    }
  },
  setup () {
    // ...
