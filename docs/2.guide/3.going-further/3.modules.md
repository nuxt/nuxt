...
Any community modules are welcome to be listed on [the module list](/modules). To be listed, [open an issue in the nuxt/modules](https://github.com/nuxt/modules/issues/new?assignees=&labels=module-request&template=module_request.yml&title=%5BModule+Listing+Request%5D%3A+%60...%60) repository. The Nuxt team can help you to apply best practices before listing.
...
If you have an already published and working module, and want to transfer it to `nuxt-modules`, [open an issue in nuxt/modules](https://github.com/nuxt/modules/issues/new?assignees=&labels=module-request&template=module_request.yml&title=%5BModule+Listing+Request%5D%3A+%60...%60).
