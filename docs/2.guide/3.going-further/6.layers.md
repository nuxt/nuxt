...
::alert
Check [nuxt-themes/starter](https://github.com/nuxt-themes/starter) for a more opinionated starter for authoring Nuxt themes. It can initialize with:
...
To publish a layer directory as an npm package, you'll want to verify that the `package.json` has the correct properties filled out. This will guarantee the files are included in the package when it gets published.
