...
::tip
If you want to extend a remote source from GitHub or GitLab instances, you need to add the environment variable `GIGET_GITHUB_URL=<url>` or `GIGET_GITLAB_URL=<url>` to provide a url.
::
