...
::tip
If you want to extend a remote source from a self-hosted GitHub or GitLab instance, you will need to supply its URL with an environment variable: `GIGET_GITHUB_URL=<url>` or `GIGET_GITLAB_URL=<url>`.
::
