...
Auto-scanned layers (from your `~~/layers` directory) automatically create aliases. For example, you can access the `srcDir` of your `~~/layers/test` layer via `#layers/test`.
...
This will produce an alias of `#layers/example` which points to the `srcDir` of your layer.
