...
When using git remote sources, if a layer has npm dependencies, you no longer need to manually install them in the target project since Nuxt 3.8.0 (read more in [c12 release notes](https://github.com/unjs/c12/releases/tag/v1.5.1)).
::
