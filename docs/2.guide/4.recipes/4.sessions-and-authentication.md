...
::important
:warning: Remember that your data aren't really secure without server-side protection! Always secure your data server-side first before worrying about the client-side.
::
