...
::alert
You can also auto-import functions exported from custom folders or third-party packages by configuring the [`imports` section](/docs/api/nuxt-config#imports) of your `nuxt.config` file.
::
