...
Thanks to its opinionated directory structure, Nuxt can auto-import your [`app/components/`](/docs/guide/directory-structure/components), [`app/composables/`](/docs/guide/directory-structure/composables) and [`app/utils/`](/docs/guide/directory-structure/utils).
...
- `app/components/` for [Vue components](/docs/guide/directory-structure/components).
- `app/composables/` for [Vue composables](/docs/guide/directory-structure/composables).
