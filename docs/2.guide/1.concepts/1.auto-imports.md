...
If you want to auto-import functions exported from custom folders or modules, check out the [`imports` section](/docs/api/configuration/nuxt-config#imports) in the configuration documentation.
