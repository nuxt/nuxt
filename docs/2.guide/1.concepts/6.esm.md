...
However, if you try to import a package with a `.esm.js` file in a Node.js ESM context, it won't work, and you'll get an error like this:
...
You may find that you _also_ need to add the packages imported by these libraries.
