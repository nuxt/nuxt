...
::alert{type=info}
The `utils/` directory allows for a semantic distinction between your Vue composables and other auto-imported utility functions.

How `utils/` auto-imports work and are scanned is identical to [the composables/ directory](/docs/guide/directory-structure/composables). You can see examples and more information about how they work in that section of the docs.
::
