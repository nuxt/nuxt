...
::tip{icon="i-lucide-video" to="https://vueschool.io/lessons/define-nuxt-route-middleware?friend=nuxt" target="\_blank"}
Watch this video from Vue School on all 3 kinds of middleware
::
