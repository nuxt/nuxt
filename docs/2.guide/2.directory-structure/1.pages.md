...
As your app get bigger, the complexity of your routing might require more flexibility.
Nuxt can directly expose the router and provides several ways to extend it see the [Custom router](/docs/2.guide/3.going-further/12.custom-router.md) guide for more informations.