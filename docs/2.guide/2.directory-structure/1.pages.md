...
If your want to preserve the state for parent routes, use this syntax: `<NuxtPage keepalive />`. You can also set props to pass to `<KeepAlive>` (see the entire list [here](https://vuejs.org/api/built-in-components.html#keepalive)).
