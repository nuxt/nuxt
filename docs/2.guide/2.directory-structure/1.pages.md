...
::tip{icon="i-lucide-video" to="https://vueschool.io/lessons/dynamic-route-params-in-nuxt-js?friend=nuxt" target="\_blank"}
Watch this video from Vue School on dynamic routes
::
