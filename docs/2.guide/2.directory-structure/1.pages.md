...
You can define the page as an [island](/docs/guide/directory-structure/components#server-components). Which means it will be rendered server only. This is an alternative to the `.server.vue` suffix in the filename.
