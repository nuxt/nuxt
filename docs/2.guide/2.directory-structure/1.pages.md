...
While the file routing system is convenient, it may be difficult for you to organise your project. To help you with this problem, Nuxt introduces the route group feature. you can use parenthesis (`(` and `)`) to divide the files into separate folders without affecting your application 's URL structure.
