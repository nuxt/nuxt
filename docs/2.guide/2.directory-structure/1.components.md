...
If you want to use the Vue `<component :is="someComputedComponent">` syntax, you can use the `resolveComponent` helper provided by Vue or import the component directly from `#components` and pass it into `is` prop.
