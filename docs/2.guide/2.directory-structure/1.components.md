...
Alternatively, though not recommended, you can register all your components globally, thus creating async chunks for all your components and making them available throughout your application.
...
If a component is to be rendered only client-side, you can add the `.client` suffix to it.
