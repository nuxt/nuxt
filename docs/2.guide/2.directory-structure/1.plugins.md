...
::note
If you are using the object-syntax, the properties may be statically analyzed in the future to produce a more optimized build. So you should not define them at runtime. :br
