...
::warning
To use these auto-imported utils and types, you must first [set `compatibilityVersion: 4` in your `nuxt.config.ts`](/docs/getting-started/upgrade#opting-in-to-nuxt-4).  
