...
Route groups are automatically available in the route metadata as `route.meta.group`.
...
console.log(route.meta.group) // Output: ['marketing']
</script>

<template>
  <div>
    <p v-if="route.meta.group.includes('marketing')">
