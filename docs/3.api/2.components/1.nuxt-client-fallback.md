...
- **placeholder** | **fallback**: Specify fallback content to be rendered if the slot fails to render.
  - **type**: `string`
- **strategy**: Specify a strategy to adopt once client-side. By default it tries to re-render the slot on the client but you can choose to keep the fallback content by setting this prop to `keep-fallback`
