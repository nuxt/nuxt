...
::warning
if you are using `onRequest` to set `options.params` is invalid(`ofetch>=1.4.0`), please use `options.query` instead. And `params` maight be removed in the future, please use `query` instead.
::
