...
- `progressTimingFunction`: Specifies a function that will calculate the progress value based on duration and elapsed time.  (default [function](https://github.com/nuxt/nuxt/blob/main/packages/nuxt/src/app/composables/loading-indicator.ts#L38))
