...
::note
You can hook into the underlying indicator instance using the [`useLoadingIndicator`](/docs/api/composables/use-loading-indicator) composable, which will allow you to trigger start/finish events yourself.
::
