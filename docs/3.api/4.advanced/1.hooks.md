...
`nitro:build:assets`     | `nitro`                    | Called after copying public assets into `nitro.options.output.publicDir`. Allows modifying public assets before Nitro server is built.
