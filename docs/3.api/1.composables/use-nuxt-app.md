...
`payload` exposes data and state variables from server side to client side and makes them available in the payload object that is accessible from the browser.
