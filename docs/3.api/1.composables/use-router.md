...
The [`useRouter`](/docs/api/composables/use-router)  composable returns the router instance and must be called in the [Nuxt context](/docs/guide/going-further/nuxt-app#the-nuxt-context).
