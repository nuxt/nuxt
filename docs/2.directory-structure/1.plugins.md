...
You can use [composables](/docs/directory-structure/composables) as well as [utils](/docs/directory-structure/utils) within Nuxt plugins:
...
::important
Note that we highly recommend using [`composables`](/docs/directory-structure/composables) instead of providing helpers to avoid polluting the global namespace and keep your main bundle entry small.
::
