...
Layouts are enabled by adding [`<NuxtLayout>`](/docs/api/components/nuxt-layout) to your [`app.vue`](/docs/directory-structure/app/app):
...
::important
If you only have a single layout in your application, we recommend using [`app.vue`](/docs/directory-structure/app/app) instead.
::
...
You can also pass props when changing the layout dynamically with [`setPageLayout`](/docs/api/utils/set-page-layout):
