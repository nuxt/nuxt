...
You can also set layouts for specific routes using the `appLayout` property in route rules: :versionBadge{version="4.3"}
...
## Passing Props to Layouts :versionBadge{version="4.4"}
