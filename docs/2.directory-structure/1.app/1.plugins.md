...
You can use [composables](/docs/directory-structure/app/composables) as well as [utils](/docs/directory-structure/app/utils) within Nuxt plugins:
...
::important
Note that we highly recommend using [`composables`](/docs/directory-structure/app/composables) instead of providing helpers to avoid polluting the global namespace and keep your main bundle entry small.
::
