...
If you want to group components in a directory without affecting their name, you can use the parenthesis `(` `)` to name the grouping directory :versionBadge{version="4.6"}.
