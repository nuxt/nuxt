...
You can access [plugin injections](/docs/directory-structure/app/plugins#providing-helpers) from composables:
...
Nuxt only scans files at the top level of the [`app/composables/` directory](/docs/directory-structure/app/composables), e.g.:
