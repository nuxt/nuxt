...
The `test/` directory is the recommended place for your application tests. Nuxt does not scan it the way it does `app/` or `server/`; you choose the runner and layout yourself (typically with [`@nuxt/test-utils`](/docs/getting-started/testing)).
...
::read-more{to="/docs/getting-started/testing#organizing-your-tests"}
