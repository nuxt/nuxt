...
::tip
The way `shared/utils` and `shared/types` auto-imports work and are scanned is identical to the [`composables/`](/docs/directory-structure/composables) and [`utils/`](/docs/directory-structure/utils) directories.
::

:read-more{to="/docs/directory-structure/composables#how-files-are-scanned"}
