...
You can access [plugin injections](/docs/directory-structure/plugins#providing-helpers) from composables:
...
Nuxt only scans files at the top level of the [`composables/` directory](/docs/directory-structure/composables), e.g.:
