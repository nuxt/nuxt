...
Server components can either be used on their own or paired with a [client component](/docs/directory-structure/components#paired-with-a-client-component).
