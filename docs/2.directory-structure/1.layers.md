...
- [`app.config.ts`](/docs/directory-structure/app-config) - Reactive application configuration
- [`components/`](/docs/directory-structure/components) - Vue components (auto-imported)
- [`composables/`](/docs/directory-structure/composables) - Vue composables (auto-imported)
- [`utils/`](/docs/directory-structure/utils) - Utility functions (auto-imported)
- [`pages/`](/docs/directory-structure/pages) - Application pages
- [`layouts/`](/docs/directory-structure/layouts) - Application layouts
- [`middleware/`](/docs/directory-structure/middleware) - Route middleware
- [`plugins/`](/docs/directory-structure/plugins) - Nuxt plugins
