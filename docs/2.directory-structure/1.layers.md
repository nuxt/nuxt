...
Alternatively, order your layers from `nuxt.config` using [`app.layerOrdering`](/docs/4.x/getting-started/layers#controlling-priority), listed from lowest to highest priority. This takes precedence over directory numbering.
