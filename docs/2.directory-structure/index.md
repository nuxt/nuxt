...
The [`test/`](/docs/directory-structure/test) directory is the recommended place for application tests (unit, Nuxt runtime, and end-to-end). See [Organizing Your Tests](/docs/getting-started/testing#organizing-your-tests) for layout and setup details.
