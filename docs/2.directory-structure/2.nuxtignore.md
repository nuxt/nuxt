...
It is subject to the same specification as [`.gitignore`](/docs/directory-structure/gitignore) and `.eslintignore` files, in which each line is a glob pattern indicating which files should be ignored.
