...
The `static/` (for storing static assets) has been renamed to [`public/`]((/docs/guide/directory-structure/public)). You can either rename your `static` directory to `public`, or keep the name by setting `dir.public` in your `nuxt.config`.
