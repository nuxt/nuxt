...
::tip
If you are a module author, you can check out [more information about module compatibility](/docs/migration/module-authors) and [our module author guide](/docs/guide/modules).
::
...
:read-more{to="/docs/directory-structure/public"}
...
1. Install Volar following the instructions in the [docs](/docs/getting-started/installation#prerequisites).
...
Create a [plugin](/docs/directory-structure/app/plugins) file to globalize your store:
