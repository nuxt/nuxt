...
::note
Route middleware are navigation guards stored in the [`middleware/`](/docs/directory-structure/middleware) directory of your Nuxt application (unless [set otherwise](/docs/api/nuxt-config#middleware)).
::
