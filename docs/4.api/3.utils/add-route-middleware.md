...
::note
Route middleware are navigation guards stored in the [`app/middleware/`](/docs/directory-structure/app/middleware) directory of your Nuxt application (unless [set otherwise](/docs/api/nuxt-config#middleware)).
::
