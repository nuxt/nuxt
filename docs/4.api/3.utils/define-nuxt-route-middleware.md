...
Route middleware are stored in the [`app/middleware/`](/docs/directory-structure/app/middleware) of your Nuxt application (unless [set otherwise](/docs/api/nuxt-config#middleware)).
