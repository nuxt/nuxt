...
::tip
If you want to provide a utility that works in both server and client contexts and is usable in the [`shared/`](/docs/4.x/directory-structure/shared) directory, use [`addSharedImports`](/docs/4.x/api/kit/autoimports#addsharedimports) instead.
::
