...
| `island`          | `boolean`                                                                                | `false`  | If enabled, registers components as islands. You can read more about islands in [`<NuxtIsland/>`](/docs/api/components/nuxt-island) component description.                                                                                          |
...
| `declarationPath` | `string`                                   | `false`  | Path to component's declaration file. It is used to generate components' [type templates](/docs/api/kit/templates#addtypetemplate); if not provided, `filePath` is used instead.                                                                    |
...
| `island`          | `boolean`                                  | `false`  | If enabled, registers component as island. You can read more about islands in [`<NuxtIsland/>`](/docs/api/components/nuxt-island) component description.                                                                                            |
