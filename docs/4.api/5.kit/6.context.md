...
| `hooks`    | `NuxtHookRegistry<NuxtHooks>`                                             | The Nuxt hook system. Allows registering and listening to lifecycle events.                               |
...
| `addHooks` | `(configHooks: NuxtNestedHooks) => () => void`                            | Shortcut for `nuxt.hooks.addHooks`. Registers multiple hooks at once.                                     |
