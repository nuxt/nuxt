...
::tip
To add imports for the Nitro server context, refer to the [`addServerImports`](/docs/api/kit/nitro#addserverimports) function.
::
...
```ts
function addImports (imports: NuxtImport | NuxtImport[]): void
```
...
```ts
function addImportsSources (importSources: NuxtImportPresetSource | NuxtImportPresetSource[]): void
```
...
|-----------|------------------------------------------------------|----------|-----------------------------------------------------------------------------------|
| `from`    | `string`                                             | `true`   | Module specifier to import from.                                                  |
| `imports` | `(NuxtImportEntry \| NuxtImportPreset)[]`{lang="ts"} | `true`   | An array of entries, which can be import names, import objects or nested presets. |

- `NuxtPackageImportPreset`
