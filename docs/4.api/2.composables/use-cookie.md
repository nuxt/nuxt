...
| `readonly`    | `boolean`              | `false`                                                        | If `true`, disables writing to the cookie, on both server and client. A `default` value is still returned by the composable but is never persisted to the browser.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
