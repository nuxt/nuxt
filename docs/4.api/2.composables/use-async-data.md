...
::note
You do not need to await useAsyncData. Nuxt will still await the promise and server render the correct result. The difference is how it is handled on the client side.
