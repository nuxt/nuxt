...
**See**: [Nuxt View Transition API docs](/docs/getting-started/transitions#view-transitions-api-experimental)
...
**See**: [`app/components/` directory documentation](/docs/directory-structure/app/components)
...
::read-more{to="/docs/guide/going-further/features#features"}
...
**See**: [Nuxt documentation](/docs/directory-structure/app/composables)
...
::read-more{to="/docs/guide/modules/recipes-basics#add-keyed-functions"}
...
**See**: [`app/plugins/` directory documentation](/docs/directory-structure/app/plugins)
...
**See**: [`server/` directory documentation](/docs/directory-structure/server)
...
**See**: [tsconfig.json information](/docs/directory-structure/tsconfig)
...
**See**: [Nuxt TypeScript docs](/docs/guide/concepts/typescript)

## typesDir

Define the directory where generated types and `tsconfig.json` files will be placed.

This defaults to your `buildDir`, and is separate from it so that the configurations referenced by your project `tsconfig.json` stay in place even when Nuxt builds elsewhere (as it does when building a project that has already been run in development).
