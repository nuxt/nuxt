...
This allows you to add custom module mappings that will be included in the HTML `<script type="importmap">` tag. This feature requires [`experimental.entryImportMap`](/docs/4.x/guide/going-further/experimental-features#entryimportmap) to be enabled (default: `true`) and your browser targets to support import maps (Firefox 108+, Safari 16.4+, Chrome 89+).
...
**See**: [MDN Import Maps](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script/type/importmap)
