...
`render:options`          | `options`     | Called before instantiating the bundle renderer. | [options`](https://github.com/nuxt/framework/blob/ab125bd1c5d42a51b65e48e20d8f15a31c4d2a48/packages/nuxt/src/core/runtime/nitro/renderer.ts#L83-L87)
