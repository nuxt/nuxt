---
title: "Recipes: Injecting Code"
description: "Learn how to inject plugins, components, composables, server routes, and other assets from your module."
---

Find here common patterns used to author modules for injecting code into Nuxt applications.
