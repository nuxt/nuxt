...
| Runtime hooks, including `render:html` | `useNitroApp().hooks` from `nitropack/runtime` | `useNitroHooks()` from `nitro/app` |
| App-relative fetch | `useNitroApp().localFetch` from `nitropack/runtime` | `serverFetch()` from `nitro` |
