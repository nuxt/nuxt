...
When you [list your module](/docs/guide/modules/ecosystem#list-your-module) on [nuxt.com/modules](/modules), also set `compatibility.nuxt` in the [nuxt/modules](https://github.com/nuxt/modules) registry so the catalog can show Nuxt 3 / Nuxt 4 badges and filter by major version.
