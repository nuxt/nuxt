...
[Middlewares](/docs/directory-structure/middleware) and [pages](/docs/directory-structure/pages) run in the server and on the client during hydration. [Plugins](/docs/directory-structure/plugins) can be rendered on the server or client or both. [Components](/docs/directory-structure/components) can be forced to run on the client only as well. [Composables](/docs/directory-structure/composables) and [utilities](/docs/directory-structure/utils) are rendered based on the context of their usage.
