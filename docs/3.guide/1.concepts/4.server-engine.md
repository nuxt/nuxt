...
Server [API endpoints](/docs/directory-structure/server#server-routes) and [Middleware](/docs/directory-structure/server#server-middleware) are added by Nitro that internally uses [h3](https://github.com/h3js/h3).
...
::read-more{to="/docs/directory-structure/server#server-routes"}
...
Nuxt generates this dist when running `nuxt build` into a [`.output`](/docs/directory-structure/output) directory.
