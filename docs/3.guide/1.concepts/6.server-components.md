...
- With webpack and Rspack, scoped `:slotted()` styles in server component slots can still fail because server and client builds may generate different scope IDs ([#35573](https://github.com/nuxt/nuxt/issues/35573)).
