...
Thanks to its opinionated directory structure, Nuxt can auto-import your [`components/`](/docs/directory-structure/components), [`composables/`](/docs/directory-structure/composables) and [`utils/`](/docs/directory-structure/utils).
...
:read-more{to="/docs/directory-structure/components"}
