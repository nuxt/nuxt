...
Thanks to its opinionated directory structure, Nuxt can auto-import your [`app/components/`](/docs/directory-structure/app/components), [`app/composables/`](/docs/directory-structure/app/composables) and [`app/utils/`](/docs/directory-structure/app/utils).
...
::note
In the [`server`](/docs/directory-structure/server) directory, Nuxt auto-imports exported functions and variables from `server/utils/`.
::
...
- `app/components/` for [Vue components](/docs/directory-structure/app/components).
- `app/composables/` for [Vue composables](/docs/directory-structure/app/composables).
...
:read-more{to="/docs/directory-structure/app/components"}
