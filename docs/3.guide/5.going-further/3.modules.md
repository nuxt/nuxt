...
You'll then be able to inject all those assets inside the application from your [module definition](/docs/3.x/guide/modules#module-definition).

::tip
Learn more about asset injection in [the recipes section](/docs/3.x/guide/modules#recipes).
::
...
Having a playground Nuxt application to test your module when developing it is really useful. [The module starter integrates one for that purpose](/docs/3.x/guide/modules#how-to-develop).
