...
::warning
This feature does not currently work with Vite 8 (which will ship in Nuxt 5), as the Oxc transformer used by Rolldown does not yet support lowering decorators. This is being tracked in [oxc-project/oxc#9170](https://github.com/oxc-project/oxc/issues/9170). See the [Vite 8 migration guide](https://main.vite.dev/guide/migration#javascript-transforms-by-oxc) for possible workarounds.
::
