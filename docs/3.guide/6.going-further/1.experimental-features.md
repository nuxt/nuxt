...
- a route you registered by augmenting `ServerRoutes` by hand needs rewriting, as the two
  descriptions of a route differ (see [the upgrade guide](/docs/getting-started/upgrade#typed-fetch-rebuilt-on-generated-route-types))
...
::important
Enabling this feature changes how Vite plugins are registered and configured. See the [Vite Environment API migration guide](/docs/getting-started/upgrade#migration-to-vite-environment-api) for details on updating your plugins.
::
