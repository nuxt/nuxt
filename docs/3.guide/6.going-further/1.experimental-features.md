...
:read-more{to="/docs/directory-structure/components#server-components"}
...
This allows modules to access additional metadata from the page metadata in the build context. If you are using this within a module, it's recommended also to [augment the `NuxtPage` types with your keys](/docs/directory-structure/pages#typing-custom-metadata).
...
::read-more{icon="i-simple-icons-github" color="gray" to="/docs/directory-structure/components#delayed-or-lazy-hydration"}
