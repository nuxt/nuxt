...
- [`components/*`](/docs/directory-structure/components)   - Extend the default components
- [`composables/*`](/docs/directory-structure/composables)  - Extend the default composables
- [`layouts/*`](/docs/directory-structure/layouts)  - Extend the default layouts
- [`middleware/*`](/docs/directory-structure/middleware)  - Extend the default middleware
- [`pages/*`](/docs/directory-structure/pages)        - Extend the default pages
- [`plugins/*`](/docs/directory-structure/plugins)        - Extend the default plugins
- [`utils/*`](/docs/directory-structure/utils)   - Extend the default utils
- [`app.config.ts`](/docs/directory-structure/app-config)  - Extend the default app config
