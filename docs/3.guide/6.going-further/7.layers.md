...
A minimal Nuxt layer directory should contain a [`nuxt.config.ts`](/docs/directory-structure/nuxt-config) file to indicate it is a layer.
...
- [`app/components/*`](/docs/directory-structure/app/components)   - Extend the default components
- [`app/composables/*`](/docs/directory-structure/app/composables)  - Extend the default composables
- [`app/layouts/*`](/docs/directory-structure/app/layouts)  - Extend the default layouts
- [`app/middleware/*`](/docs/directory-structure/app/middleware)  - Extend the default middleware
- [`app/pages/*`](/docs/directory-structure/app/pages)        - Extend the default pages
- [`app/plugins/*`](/docs/directory-structure/app/plugins)        - Extend the default plugins
- [`app/utils/*`](/docs/directory-structure/app/utils)   - Extend the default utils
- [`app/app.config.ts`](/docs/directory-structure/app/app-config)  - Extend the default app config
- [`server/*`](/docs/directory-structure/server)       - Extend the default server endpoints & middleware
- [`nuxt.config.ts`](/docs/directory-structure/nuxt-config)- Extend the default nuxt config
...
## Disabling Modules from Layers :badge[v4.3]{color="info" size="xs" class="align-middle"}
