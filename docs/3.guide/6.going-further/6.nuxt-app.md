...
Currently, the Nuxt context is only accessible in [plugins](/docs/directory-structure/app/plugins), [Nuxt hooks](/docs/guide/going-further/hooks), [Nuxt middleware](/docs/directory-structure/app/middleware) (if wrapped in `defineNuxtRouteMiddleware`), and [setup functions](https://vuejs.org/api/composition-api-setup) (in pages and components).
...
::read-more{to="/docs/directory-structure/app/plugins#providing-helpers"}
