...
`nuxt.config` and [Nuxt modules](/docs/guide/modules) can be used to extend the build context, and [Nuxt Plugins](/docs/directory-structure/plugins) can be used to extend runtime.
