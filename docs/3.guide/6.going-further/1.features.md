...
On Nuxt 5 it resolves to `5`, and the defaults described in the upgrade guide apply. Individual changes are configured through the options named there rather than through this one.
...
::read-more{to="/docs/getting-started/upgrade#migrating-to-nuxt-5"}
Learn more about migrating to Nuxt 5.
::
